...
export const SpendingCategories = () => {
  ...
  // Sort categories by spending amount (highest first), filter out zero spending
      ...
      <div className="grid grid-cols-2 gap-3">
        {sortedCategories.map(([category, amount]) => {
          ...
          return (
            <div 
              key={category}
              className="bg-card rounded-2xl p-4 shadow-soft animate-fade-in hover:scale-[1.02] transition-transform"
            >
              <div className={cn(
