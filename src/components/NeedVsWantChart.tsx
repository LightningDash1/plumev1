...
export const NeedVsWantChart = ({ getNeedVsWant }: NeedVsWantChartProps) => {
  ...
  return (
    <div className="bg-card rounded-2xl p-4 shadow-soft">
      ...
      <div className="h-4 bg-secondary rounded-full overflow-hidden flex mb-4">
        <div className="bg-primary transition-all duration-500" style={{ width: `${needPercent}%` }} />
        <div className="bg-accent transition-all duration-500" style={{ width: `${wantPercent}%` }} />
      </div>
      <div className="flex justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">{formatCurrency(needs)} ({needPercent}%)</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-muted-foreground">{formatCurrency(wants)} ({wantPercent}%)</p>
          </div>
        </div>
      </div>
    </div>
